...
public class GestionTablesDesFactures implements InterfaceGestion<TablesDesFactures>{
   ES ES = new ES(); 
	...
	public void menuGeneral(TablesDesFactures tab, Object... objects) throws Exception {
		...
		int choix; 		
		Commande52<String> cde = (Commande52<String>)objects[0];
		TablesDesCommandes52 tabcde = (TablesDesCommandes52)objects[1];		
		TablesDesArticles52 tabart = (TablesDesArticles52)objects[2];
...
return ES.saisie (menu, 0, 4);
	...
	public void creer(TablesDesFactures tabFact, Object... objects)throws Exception {
		...
		TablesDesArticles52 tabArt = (TablesDesArticles52)objects[1];
		String numCde ="";
		...
		if(tabCde.retourner(numCde)==null){
			...
			Commande52<String> cde = tabCde.retourner(numCde);
	...
	public void suppressionLesFacturesPermime(TablesDesFactures tabFact, TablesDesCommandes52 tabCde) {
