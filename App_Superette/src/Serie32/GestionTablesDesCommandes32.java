...
public class GestionTablesDesCommandes32 {
	private	ES ES = new ES();	
	public GestionTablesDesCommandes32(){}
 
	
	public void menuGeneral(Commande22<Integer> cde, TablesDesArticles22 Tabart,TablesDesCommandes22 TabCde) throws AbandonException, ErreurSaisie {
...
private  void creer(TablesDesArticles22 tabart, TablesDesCommandes22 tabCde,int num ) throws AbandonException, ErreurSaisie {
 
	Commande22 <Integer> Cde = new Commande22<Integer>();
	
	Cde.SetNumCde( num);
	GestionCommande32 gestUneCde = new GestionCommande32();
...
private  void supprimer(TablesDesArticles22 tabart, TablesDesCommandes22 tabcde) throws AbandonException, ErreurSaisie {
...
private  void modifier(TablesDesArticles22 tabart, TablesDesCommandes22 tabCde) throws AbandonException, ErreurSaisie {
...
private  void afficherUneCommande(TablesDesArticles22 tabart, TablesDesCommandes22 tabcde) throws AbandonException, ErreurSaisie {
...
private  void editionFacture(TablesDesArticles22 tabart,TablesDesCommandes22 tabcde,Commande22<Integer> cde) throws AbandonException, ErreurSaisie {
	int CleEdiFacture;
