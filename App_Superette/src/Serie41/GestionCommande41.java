...
public class GestionCommande41 {
	
private ES ES = new ES();	
	public GestionCommande41(){}

	public void menuGeneral(Commande41<Integer> cde, TablesDesArticles41 tabart) throws AbandonException, ErreurSaisie{
	 
			LigneDeCommande41 ldc = new LigneDeCommande41(); 
			 int choix;
		 do{
...
private  void creer(Commande41<Integer> cde, TablesDesArticles41 tabart) throws AbandonException, ErreurSaisie {
	 int code;
	 int quantite=0;
	...
	if(art!=null){
	 ...
	 if(tabart.retourner(code)!=null){
		 ...
		 LigneDeCommande41 ldc = new LigneDeCommande41(code,quantite);
		
		 cde.ajouter(ldc); 
		 }else{
			  
			 LigneDeCommande41 ldc1 = new LigneDeCommande41(code, quantite+cde.retourner(code).getQuantite());
				cde.ajouter(ldc1);
				ES.affiche("\nQuantité Modifie!\n");
...
private void supprimer (Commande41<Integer> Cde, LigneDeCommande41 ldc) throws AbandonException, ErreurSaisie {
...
private void afficher (Commande41<Integer> cde) {
	if(cde.Taille()==0){ES.affiche(" **AUCUNE Commande est Actuellement en Cours**\n");
	 }else{		
...
//Editer Une Facture///
private void editerFacture(Commande41<Integer> Cde,TablesDesArticles41 Tabart) {
